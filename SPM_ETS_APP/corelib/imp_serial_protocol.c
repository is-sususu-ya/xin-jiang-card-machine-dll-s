...
#endif /* #define _EN_PushPull_Module (1)  */
            {
...
void local_protocol_init()
{
    ...
    pthread_create(&theApp.thread, NULL, protocol_thread, NULL); /* 上位机协议解析 */
}
