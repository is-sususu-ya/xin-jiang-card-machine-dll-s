...
static const char *getStrPayEvent(int code)
{
	switch( code )
	{
		case PAY_EVT_START:return "支付模块发起支付指令";break;
		case PAY_EVT_QUERY:return "支付模块发起查询指令";break;
		case PAY_EVT_CANCEL:return "支付模块发起取消指令";break;
		case PAY_EVT_REFUND:return "支付模块发起退款指令";break;
		case PAY_EVT_ONLINE:return "支付模块发起设备上线指令";break;
		case PAY_EVT_OFFLINE:return "支付模块发起设备离线线指令";break;
		case PAY_EVT_CTR_LED: return "支付模块发起费显控制指令";break;
		case PAY_EVT_CTR_VOICE: return "支付模块发起的语音播放指令"; break;
		default: 
		return "支付模块发起未知指令..";
		break;
	}
