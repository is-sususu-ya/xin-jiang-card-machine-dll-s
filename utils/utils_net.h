...
#define sock_peek_until(fd,buffer,buf_size,eol)	sock_peek_until_tout(fd,buffer,buf_size,eol,100)
#define sock_read_until(fd,buffer,buf_size,eol)	sock_read_until_tout(fd,buffer,buf_size,eol,100)
